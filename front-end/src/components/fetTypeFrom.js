...
function TypeFormFetcher() {
  ...
  return (
    <>
      ...
      className="py-2 px-4 shadow-xl bg-blue-500 text-white font-semibold rounded-full mt-4 shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">TypeForm'dan Data Çek</button>
      {/*allAnswers === null ? (
